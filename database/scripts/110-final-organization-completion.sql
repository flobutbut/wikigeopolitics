-- Script final pour compléter les pays membres des organisations restantes
-- Utilisation des identifiants corrects des pays
...
('uk', 'org_commonwealth', 'membre', '1931-12-11'),
...
('usa', 'rel_accord_libre_echange_na', 'membre', '1994-01-01')
ON CONFLICT (countryid, organizationid) DO NOTHING;
...
('usa', 'rel_accord_etats_unis_mexique_canada', 'membre', '2020-07-01')
ON CONFLICT (countryid, organizationid) DO NOTHING;
...
('ivory-coast', 'org_afcfta', 'membre', '2021-01-01'),
